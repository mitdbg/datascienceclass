Table of Contents
=================
- [Lab 2: Title Goes Here](#lab-0-setting-up-your-environment)
  * [1. Accessing Your EC2 Instance](#1-accessing-your-ec2-instance)
  * [2. Additional Setup](#2-additional-setup)
  * [3. Setup Lab 2 Environment](#3-setup-lab-2-environment)
...
## 3. Setup Lab 2 Environment
Inside the `lab_2` directory of your repository you should see a script called `setup.sh`. Simply execute the script as follows:
```bash
# --- on the EC2 machine ---
